...
<div class="container mt-3">
  <form action="<?= base_url('home/simpan_barangr') ?>" method="post">
   <div class="mp-3">
      <label for="tanggal_rusak">tanggal_rusak Barang :</label>
      <input type="text" class="form-control" id="tanggal_rusak" placeholder="Enter tanggal_rusak" name="tanggal_rusak"value="<?= $marah->tanggal_rusak?>">
    </div>
    <div class="mq-3">
    ...
    <tr>
      ...
      <td><input type="hidden" name="id" value="<?= $marah->id_barang ?>">
        ...
        <a href="<?= base_url('home/hapus_barangr/'.$marah->id_barang) ?>" class="btn btn-danger">Hapus </a>
    </tr>
  </form>
</div>
