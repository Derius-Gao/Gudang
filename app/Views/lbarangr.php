    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
  <form class="mt-4" action="<?= base_url('home/lbarangr_1')?>" method="POST">
    <table>
      <tr>
        <td>tanggal awal</td>
      ...
      <tr>
        ...
        <button class="btn btn-info">
           ...
           <form class="mt-4" action="<?= base_url('home/pdflapor_br')?>" method="POST" target="_blank">
             <tr>
        <td>tanggal awal</td>
      ...
      <tr>
        ...
        <form class="mt-4" action="<?= base_url('home/excellapor_br')?>" method="POST" target="_blank">
           <tr>
        <td>tanggal awal</td>
