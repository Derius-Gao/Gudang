    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
  <form action="/home/input_barangr" method="POST">
     <table>
      <tr>
        <td>jumlah</td>
      ...
      <tr>
        <td>tanggal rusak</td>
        <td><input type="text" class="form-control" name="tanggal_rusak" value="<?= $marah->tanggal_rusak?>"></td>
      </tr>
      <tr>
        <td>Nama barang</td>
